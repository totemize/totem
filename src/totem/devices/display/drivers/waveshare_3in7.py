...
It adds our specific functionality (error handling, Storage compatibility, etc.) on top
...
# Flag for Storage compatibility (uses alternative pins and software SPI)
...
class WaveshareEPD3in7:
    ...
    def __init__(self, mock_mode=None, handle_errors=None, busy_timeout=None):
        ...
        if self.nvme_compatible:
            print("Running in Storage-compatible mode with software SPI")
    ...
    def _import_manufacturer_driver(self):
        ...
        try:
            ...
            # Import the vendored manufacturer module shipped with Totem.
            try:
                from totem.devices.display.waveshare_epd import epd3in7
