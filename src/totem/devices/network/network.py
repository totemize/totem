...
WIFI_DRIVERS = DriverRegistry(
    WiFiDeviceInterface,
    (
        DriverSpec("rpi5_onboard_wifi", "totem.devices.network.drivers.rpi5_onboard_wifi"),
        DriverSpec("usb_wifi_adapter", "totem.devices.network.drivers.usb_wifi_adapter"),
        DriverSpec("mock_wifi", "totem.devices.network.drivers.mock_wifi", is_mock=True),
    ),
)
