...
NFC_DRIVERS = DriverRegistry(
    NFCDeviceInterface,
    (
        DriverSpec("acr122", "totem.devices.nfc.drivers.acr122"),
        DriverSpec("pn532", "totem.devices.nfc.drivers.pn532"),
        DriverSpec("mock_nfc", "totem.devices.nfc.drivers.mock_nfc", is_mock=True),
    ),
)
