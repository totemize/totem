#!/bin/bash
# Script to run the E-Ink software CS test

# Make the script executable
chmod +x test_eink_sw_cs.py
...
# Run the test
echo "Running E-Ink software CS test..."
sudo python3 test_eink_sw_cs.py | tee eink_sw_cs_test_results.log
...
echo "Test results saved to eink_sw_cs_test_results.log" 