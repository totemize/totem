...
class Driver(WiFiDeviceInterface):
    ...
    def init(self):
        logger.info("Initializing onboard Wi-Fi.")
    ...
    def scan_networks(self) -> list:
        ...
        try:
            result = subprocess.check_output(['nmcli', '-t', '-f', 'SSID,SIGNAL', 'dev', 'wifi', 'list'], text=True)
    ...
    def create_hotspot(self, ssid: str, password: str):
        ...
        try:
            ...
            logger.info(f"Created Wi-Fi hotspot '{ssid}'.")
        except Exception as e:
    ...
    def disconnect(self):
        ...
        try:
            ...
            logger.info("Disconnected from Wi-Fi network.")
        except Exception as e:
        ...
        try:
            ...
            for line in result.strip().split('\n'):
                ...
                if parts[0] == self.interface:
                    ...
                    logger.debug(f"Wi-Fi status: {status}")
                    return status
            return "Unknown"
        except Exception as e:
