...
| [2026-08-21 — Myco integration and Totem napplet](journal/2026-08-21.md#myco-pairing-native-file-sharing-and-totem-nearby-napplet) | Added a separate headless Myco pairing/file service and conformant ContextVM Totem napplet; later rebased it onto the radio substrate and added local-only CoC→FIPS, Aware→FIPS UDP, LAN, and SoftAP lane adapters while preserving FIPS-TUN fallback. |
