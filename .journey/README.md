...
| Date | Summary |
|------|---------|
| [2026-08-20 — static Svelte web app](journal/2026-08-20.md#totemd-static-svelte-web-app) | Replaced the SSR root with an embedded Svelte 5/Vite app; retained NIP-98 claim/profile/policy; added public aggregate reactivity and an owner-signed status/peers/history/live-event stream without exposing the loopback bus; live-deployed and browser-verified on totem. |
