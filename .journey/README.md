...
| Date | Summary |
|------|---------|
| [2026-08-20 — periodic reconciliation](journal/2026-08-20.md#totemd-periodic-reconciliation-and-event-history) | Added bounded process-local event history and five-minute non-overlapping NIP-77 rounds; deployed and live-verified attempts 1–2 on motown only. |
